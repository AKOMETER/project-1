...
function Video(props) {
    ...
    const handleUpload = () => {
        ...
        if (templatename !== ' ') {
            ...
            axios.post(`${config.baseUrl}upload/image?user_id=${userid}`, formData, {
                headers: {
                ...
                <div className=' flex justify-between flex-wrap-reverse'>
                    <div className='flex-1'>
                        <div className=' flex-1 flex flex-col px-5 mt-2 gap-2'>
                            ...
                            {/* Progress Bar */}
                            {/* {buttonloading && <div className="w-full bg-gray-200 rounded-full mt-2">
                                <div className="bg-green-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" style={{ width: `${uploadProgress}%` }}>{uploadProgress}%</div>
                            </div>} */}
