...
function Login() {
  ...
  const HandleLogin = () => {
    axios
      .post(`${config.baseUrl}login/`, ldata)
      .then((response) => {
        if (response && response.data) {
          ...
          console.log("Feature Token:", featuretoken);
          ...
          if (accessToken) {
            ...
            const is_staff = decodedToken?.user_is_staff;
            const is_distributor = decodedToken?.user_is_distributor;

            console.log("Is Staff:", is_staff);
            console.log("Is Distributor:", is_distributor);
          ...
          if (featuretoken) {
            Cookies.set("ft", featuretoken, {
              expires: 5,
              sameSite: "None",
              secure: true,
            });
          } else {
            console.error("Feature token is missing in the response.");
          }
        } else {
  ...
  const HandleSignUp = (e) => {
    ...
    if (validateForm()) {
      ...
      setloading(true);
      axios
        .post(`${config.baseUrl}register/`, formData)
        .then((response) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full gap-3 background-doodle h-[100dvh] ">
            ...
            login ? (
              <>
                <div className="container mx-auto py-8">
                  <div className=" mx-auto min-w-min  bg-white rounded shadow   ">
                    <div className="py-4 px-12 text-black text-center text-xl border-b border-grey-lighter whitespace-nowrap">
                      Log In to Altos Connect
                    </div>
                    <div className="py-4 px-8">
                      ...
                      {errormesssagel && (
                        <div className="text-xs text-center whitespace-nowrap font-semibold text-red-500">
                          {errormesssagel}
                        </div>
                      )}
                      ...
                      <div className="flex items-center justify-end mt-8">
                        <button
                          className="bg-blue hover:bg-blue-dark bg-green-950 text-white font-bold py-2 px-4 rounded-full"
                          type="submit"
                          onClick={HandleLogin}
                        >
                          Login &#x279C;
                      ...
                      <p className="text-center text-green-950 mb-4">
                        <button
                          ...
                          className="text-grey-dark text-sm no-underline hover:text-grey-darker whitespace-nowrap"
                        >
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I am new
                          here. Sign me
                          Up&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <form className="container mx-auto py-8" onSubmit={HandleSignUp}>
                <div className="w-5/6 lg:w-5/6 mx-auto  bg-white rounded shadow   ">
                  <div className="py-4 px-8 text-black text-center text-xl border-b border-grey-lighter whitespace-nowrap">
                    Register to Altos Connect
                  </div>
                  ...
                  <div className="py-4 px-8">
                      ...
                      <div className="w-1/2 mr-1">
                        ...
                        <div className="text-red-500 text-[10px] text-center">
                          {validationErrors.first_name && (
                            <p>{validationErrors.first_name}</p>
                          )}
                        </div>
                      </div>
                      <div className="w-1/2 ml-1">
                        ...
                        <div className="text-red-500 text-[10px] ">
                          {validationErrors.last_name && (
                            <p>{validationErrors.last_name}</p>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        className="appearance-none border rounded  py-2 px-3 text-grey-darker w-full"
                        id="company"
                        type="text"
                    ...
                    {signupmessage && (
                      <div className="text-xs text-center whitespace-nowrap">
                        A Generated password will be received <br></br>in your{" "}
                        <a
      ...
      {loading && (
        <div className=" absolute w-full h-full top-0 left-0 flex justify-center items-center bg-black/40">
          <svg
