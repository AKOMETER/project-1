...
const useTemplateListApi = (forceFetch = false) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (!forceFetch && (storedData && lastFetchTime) && (Date.now() - parseInt(lastFetchTime, 10)) < 360) {
...
export default useTemplateListApi;
